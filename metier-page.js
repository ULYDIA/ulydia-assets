...
(() => {
  ...
  const CFG = {
    ...
    LABELS: {
      ...
      en: { description:"Description", missions:"Missions", competences:"Skills", environnements:"Environments", evolutions:"Career paths", specifique_pays:"Country specific", faq:"FAQ", not_available:"—", sponsored_by:"Sponsored by" },
      de: { description:"Beschreibung", missions:"Aufgaben", competences:"Kompetenzen", environnements:"Umgebungen", evolutions:"Entwicklung", specifique_pays:"Länderspezifisch", faq:"FAQ", not_available:"—", sponsored_by:"Gesponsert von" },
      es: { description:"Descripción", missions:"Misiones", competences:"Competencias", environnements:"Entornos", evolutions:"Evolución", specifique_pays:"Específico del país", faq:"FAQ", not_available:"—", sponsored_by:"Patrocinado por" },
      it: { description:"Descrizione", missions:"Missioni", competences:"Competenze", environnements:"Ambienti", evolutions:"Evoluzione", specifique_pays:"Specifico per paese", faq:"FAQ", not_available:"—", sponsored_by:"Sponsorizzato da" },
    },
  };
...
`<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="500">
  ...
  const UI = (() => {
    ...
    function renderAll({ ctx, model, banners }) {
      ...
      for (const s of sections) { if (isNonEmpty(s.value)) { defaultId = s.id; break; } }
