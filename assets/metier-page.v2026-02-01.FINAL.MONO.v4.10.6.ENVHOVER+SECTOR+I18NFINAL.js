...
function renderPage(ctx){
    ...
    var lang = langFromCtx(ctx);
    var sectorLabel = sectorToLabel(ctx.sector);
    var pillsHTML = '';
    if (sectorLabel){
...
var ctx = {
      ...
      sector: (metier && (metier.secteur || metier.sector || metier.secteur_activite || metier.secteurActivite || metier.secteur_d_activite || metier["Secteur d’activité"] || metier["Secteur d'activite"] || metier["Secteur d\u2019activité"] || metier["Secteur d\u2019activite"])) ||
              (fiche  && (fiche.secteur  || fiche.sector  || fiche.secteur_activite  || fiche.secteurActivite  || fiche.secteur_d_activite  || fiche["Secteur d’activité"]  || fiche["Secteur d'activite"]  || fiche["Secteur d\u2019activité"]  || fiche["Secteur d\u2019activite"])) ||
              (mpb    && (mpb.secteur    || mpb.sector    || mpb.secteur_activite    || mpb.secteurActivite    || mpb.secteur_d_activite    || mpb['secteur'] || mpb['sector'] || mpb['secteur_activite'] || mpb['secteur d\u2019activite'] || mpb["Secteur d’activité"] || mpb["Secteur d\u2019activité"] || mpb["Secteur d'activite"])) || '',
