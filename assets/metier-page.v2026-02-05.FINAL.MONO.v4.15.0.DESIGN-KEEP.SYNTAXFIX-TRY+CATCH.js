...
// Append columns (FIX: left was missing in v4.8)
    ...
    try{ console.error('[ULYDIA] renderPage failed', e); }catch(_e){}
    try{
      var root = ensureRoot();
      root.innerHTML = '<div class="u-card"><div class="u-card-h">Render error</div><div class="u-card-b">' + esc(String(e && (e.message||e) || 'Unknown error')) + '</div></div>';
    }catch(_e2){}
  }
