...
var ctx = {
      ...
      sector: (metier && (
                metier.secteur || metier.sector ||
                metier.secteur_activite || metier.secteurActivite || metier.secteur_d_activite ||
                metier.secteurActiviteRef || metier.secteur_activite_ref || metier.secteur_d_activite_ref ||
                metier.secteurActivite_name || metier.secteur_activite_name || metier.secteur_d_activite_name ||
                metier["Secteur d’activité"] || metier["Secteur d'activite"] || metier["Secteur d\u2019activité"] || metier["Secteur d\u2019activite"] ||
                metier["Secteur d’activité (ref)"] || metier["Secteur d'activité (ref)"]
              )) ||
              (fiche && (
                fiche.secteur || fiche.sector ||
                fiche.secteur_activite || fiche.secteurActivite || fiche.secteur_d_activite ||
                fiche.secteurActiviteRef || fiche.secteur_activite_ref || fiche.secteur_d_activite_ref ||
                fiche.secteurActivite_name || fiche.secteur_activite_name || fiche.secteur_d_activite_name ||
                fiche["Secteur d’activité"] || fiche["Secteur d'activite"] || fiche["Secteur d\u2019activité"] || fiche["Secteur d\u2019activite"] ||
                fiche["Secteur d’activité (ref)"] || fiche["Secteur d'activité (ref)"]
              )) ||
              (mpb && (
                mpb.secteur || mpb.sector ||
                mpb.secteur_activite || mpb.secteurActivite || mpb.secteur_d_activite ||
                mpb.secteurActiviteRef || mpb.secteur_activite_ref || mpb.secteur_d_activite_ref ||
                mpb.secteurActivite_name || mpb.secteur_activite_name || mpb.secteur_d_activite_name ||
                mpb['secteur'] || mpb['sector'] || mpb['secteur_activite'] || mpb['secteur d\u2019activite'] ||
                mpb["Secteur d’activité"] || mpb["Secteur d\u2019activité"] || mpb["Secteur d'activite"] ||
                mpb["Secteur d’activité (ref)"] || mpb["Secteur d'activité (ref)"]
              )) || '',
