...
*/
window.__METIER_PAGE_BUILD__ = "metier-page v2026-01-25 BASE.FIX3 (event bus + bloc exposed; KPI/salary placeholders for patches)";
...
(() => {
  ...
  if (window.__ULYDIA_METIER_BOOT_VER__ === "2026-01-23-1805") return;
  window.__ULYDIA_METIER_BOOT_VER__ = "2026-01-23-1805";
