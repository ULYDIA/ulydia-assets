...
window.__METIER_PAGE_BUILD__ = "metier-page v2026-01-23-1735 (strict catalog banner_1->wide banner_2->square + block unsupported CMS lang)";
...
const actual = String(contentLang || "").toLowerCase();
