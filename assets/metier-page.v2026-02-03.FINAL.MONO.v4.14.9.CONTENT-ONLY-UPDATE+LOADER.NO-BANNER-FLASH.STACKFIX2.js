...
function renderPage(ctx){ return __renderPageImpl(ctx); }
function __renderPageImpl(ctx){
    if (ctx && ctx.__rendering) return;
    if (ctx) ctx.__rendering = true;
    try {
...
(function(){
  try{
    ...
    } finally { if (ctx) ctx.__rendering = false; }
})();