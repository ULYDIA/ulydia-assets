...
`;
  ...
  function renderTopBanner(ctx){
    ...
    var wide = pickUrl(
      sponsor && (sponsor.logo_wide || sponsor.logoWide || sponsor.logo_2 || sponsor.sponsor_logo_2 || sponsor.banner_wide || sponsor.bannerWide),
    ...
    var href = '/sponsor?metier='+encodeURIComponent(ctx.slug)+'&country='+encodeURIComponent(ctx.iso);
  ...
  function renderPremiumCard(ctx){
    ...
    var square = pickUrl(
      sponsor && (sponsor.logo_square || sponsor.logoSquare || sponsor.logo_1 || sponsor.sponsor_logo_1 || sponsor.banner_square || sponsor.bannerSquare),
