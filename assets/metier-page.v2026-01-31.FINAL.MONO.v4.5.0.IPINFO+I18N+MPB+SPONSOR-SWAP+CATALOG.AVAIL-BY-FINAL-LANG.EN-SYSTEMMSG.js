...
(function(){
  ...
  return normLang((ctx && (ctx.finalLang || (ctx.country && (ctx.country.lang || ctx.country.language || ctx.country.default_lang || ctx.country.defaultLang)))) || 'en');
}
...
var finalLang = normLang((country && (country.lang || country.language || country.default_lang || country.defaultLang)) || 'en');
