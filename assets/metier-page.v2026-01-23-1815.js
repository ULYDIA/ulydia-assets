...
*/
window.__METIER_PAGE_BUILD__ = "metier-page v2026-01-23-1815 (robust catalog match + strict b1->wide b2->square + overlay)";
...
const wide = pickUrl(pickFirst(
  b?.banner_1, b?.wide, b?.banner_wide, b?.image_wide,
  o?.banner_1, o?.wide, o?.banners?.banner_1
));
const square = pickUrl(pickFirst(
  b?.banner_2, b?.square, b?.banner_square, b?.image_square,
  o?.banner_2, o?.square, o?.banners?.banner_2
));
