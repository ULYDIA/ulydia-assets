...
(() => {
  ...
  async function main() {
    ...
    const b = ctry?.banners || {};
    // Catalog naming variants:
    // - banner_1 / banner_2
    // - image_1 / image_2  (your catalog.json)
    // - banner_wide / banner_square
    const fallbackWide   = pickUrl(b.banner_1 || b.image_1 || b.banner_wide   || ctry?.banner_wide);
    const fallbackSquare = pickUrl(b.banner_2 || b.image_2 || b.banner_square || ctry?.banner_square);
