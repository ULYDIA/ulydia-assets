  ...
  function injectCSS(){
    ...
    var css = `      :root {
      ...
      * { font-family: var(--font-family); box-sizing: border-box; }
      ...
      .u-title{font-size:46px;line-height:1.05;font-weight:800;letter-spacing:-0.03em;margin:0 0 10px;color:var(--text);}
      @media(max-width:980px){.u-title{font-size:36px;}}
      .u-sub{font-size:15px;color:var(--muted);margin:0 0 18px;line-height:1.45;}
      .u-badges{display:flex;flex-wrap:wrap;gap:10px;margin:14px 0 26px;}
      .u-hero{margin-bottom:22px;}

      /* ---- Gradients / Pastels (headers) ---- */
      .pastel-gradient-red    { background: linear-gradient(135deg, #fff5f5 0%, #ffe4e4 50%, #ffd6d6 100%); }
      .pastel-gradient-blue   { background: linear-gradient(135deg, #f0f7ff 0%, #e0efff 50%, #d0e7ff 100%); }
      .pastel-gradient-green  { background: linear-gradient(135deg, #f0fff4 0%, #dcfce7 50%, #c6f6d5 100%); }
      .pastel-gradient-purple { background: linear-gradient(135deg, #faf5ff 0%, #f3e8ff 50%, #ede4ff 100%); }
      .pastel-gradient-orange { background: linear-gradient(135deg, #fffaf0 0%, #fff0e0 50%, #ffe6d0 100%); }
      .pastel-gradient-cyan   { background: linear-gradient(135deg, #f0fdff 0%, #e0f7fa 50%, #d0f0f5 100%); }

      /* Compatibility (existing JS uses pastel-*) */
      .pastel-blue   { background: linear-gradient(135deg, #f0f7ff 0%, #e0efff 50%, #d0e7ff 100%); }
      .pastel-purple { background: linear-gradient(135deg, #faf5ff 0%, #f3e8ff 50%, #ede4ff 100%); }
      .pastel-green  { background: linear-gradient(135deg, #f0fff4 0%, #dcfce7 50%, #c6f6d5 100%); }
      .pastel-orange { background: linear-gradient(135deg, #fffaf0 0%, #fff0e0 50%, #ffe6d0 100%); }
      .pastel-pink   { background: linear-gradient(135deg, #fff5f5 0%, #ffe4e4 50%, #ffd6d6 100%); }
      .pastel-cyan   { background: linear-gradient(135deg, #f0fdff 0%, #e0f7fa 50%, #d0f0f5 100%); }

      .gradient-primary{ background:linear-gradient(135deg,#c00102 0%,#ff4d4d 100%); }
      ...
      .sponsor-logo-square img{ width:100%; height:100%; object-fit:contain; display:block; }
      ...
      .badge-primary{ background:rgba(192,1,2,0.10); border-color:rgba(192,1,2,0.25); color:var(--primary); }
      .badge-success{ background:rgba(34,197,94,0.10); border-color:rgba(34,197,94,0.25); color:#22c55e; }
      .badge-warning{ background:rgba(249,115,22,0.10); border-color:rgba(249,115,22,0.25); color:#f97316; }
      .badge-danger { background:rgba(239,68,68,0.10); border-color:rgba(239,68,68,0.25); color:#ef4444; }
      ...
      .kpi-box:hover{
        ...
        box-shadow:0 4px 16px rgba(192,1,2,0.15);
      }
      .kpi-icon{
        width:38px;height:38px;border-radius:10px;
        display:flex;align-items:center;justify-content:center;
        background:rgba(192,1,2,0.10);
        color:var(--primary);
        flex:0 0 auto;
      }
      .kpi-label{font-size:12px;color:var(--muted);font-weight:600;margin:0;}
      .kpi-value{font-size:14px;color:var(--text);font-weight:800;margin:0;}
      ...
      /* FAQ */
      .u-faq-item{border:1px solid var(--border);border-radius:var(--radius-lg);background:#fff;overflow:hidden;box-shadow:var(--shadow-card);}
      .u-faq-q{padding:14px 16px;font-weight:800;cursor:pointer;display:flex;justify-content:space-between;gap:12px;}
      .u-faq-a{padding:0 16px 16px 16px;color:var(--text);display:none;}
