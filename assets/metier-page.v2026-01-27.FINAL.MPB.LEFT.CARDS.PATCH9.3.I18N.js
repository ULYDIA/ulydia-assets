(function(){
  ...
  function splitCommaAlways(s){
    var base = splitLines(s);
    var out = [];
    for (var i=0;i<base.length;i++){
      var parts = String(base[i]||"").split(",");
  ...
  function run(){
    ...
    var sEmp      = splitCommaAlways(employers);
    var sHire     = splitCommaAlways(hiringSectors);
