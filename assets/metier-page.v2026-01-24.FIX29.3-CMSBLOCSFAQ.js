...
function applyPaysBloc(payload, slug, iso) {
    ...
    if (Array.isArray(b.sections)) {
      ...
      if (byKey.acces_bloc && !isEmptyRich(byKey.acces_bloc.value)) setRich("acces-title", byKey.acces_bloc.value);
      if (byKey.marche_bloc && !isEmptyRich(byKey.marche_bloc.value)) setRich("marche-title", byKey.marche_bloc.value);
      if (byKey.salaire_bloc && !isEmptyRich(byKey.salaire_bloc.value)) setRich("salaire-title", byKey.salaire_bloc.value);
      if (byKey.formation_bloc && !isEmptyRich(byKey.formation_bloc.value)) setRich("formation-title", byKey.formation_bloc.value);
