...
*/
(() => {
  const __GUARD__ = "__ULYDIA_METIER_BOOT_V131C3__";
  // Ignore any legacy guards that could be set by other scripts
...
try {
  ...
  function renderShell(root) { root.innerHTML = `<div data-ulydia-metier-shell="1" class="w-full h-full" style="background: linear-gradient(180deg, #f8fafc 0%, #ffffff 100%);"><!-- Barre de Filtres -->
